  ...
  return (
    <>
      <div className="bg-[#e1ccb4] h-auto px-8 md:px-16 lg:px-32 py-12">
        <div className="pb-8">
          <h1 className="text-2xl md:text-3xl text-center md:text-left text-red-700 opacity-70">BREATHE EASY</h1>
        </div>
        <div className="pb-7 w-full md:w-[38rem] mx-auto md:mx-0">
          <p className="text-center md:text-left text-red-700">
        ...
        <div className="flex flex-col md:flex-row md:space-x-8">
          <div className="mb-6 md:mb-0">
            <p className="w-full md:w-[24rem] text-center md:text-left text-red-700">
